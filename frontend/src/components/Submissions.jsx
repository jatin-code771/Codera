...
const SubmissionResults = ({ submission }) => {
  // Extract memory and time from testCases array
  const memoryArr = submission.testCases
    .map(tc => tc.memory)
    .filter(m => m); // Filter out null/undefined values
  
  const timeArr = submission.testCases
    .map(tc => tc.time)
    .filter(t => t); // Filter out null/undefined values
